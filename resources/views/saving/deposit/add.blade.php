            ...
            <div class="card">
                <div class="card-body card-padding">
                    ...
                    <!-- <div class="form-group fg-line">
                        ...
                        <input type="text" class="form-control" name="pokok" data-validation="number">
                    </div>

                    <div class="form-group fg-line">
                        <label>Simpanan Wajib</label>
                        <input type="text" class="form-control" name="wajib" data-validation="number">
                    </div>

                    <div class="form-group fg-line">
                        <label>Simpanan Sukarela</label>
                        <input type="text" class="form-control" name="sukarela" data-validation="number">
                    </div> -->
